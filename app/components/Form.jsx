...
function Form() {
  ...
  return (
    <div className=' bg-white p-16 rounded-2xl '>
       ...
       <div className='w-[100%]'>
        <input type="text" placeholder='Adicione um título'
            onChange={(e)=>setTitle(e.target.value)}
        className='text-[35px] outline-none font-bold w-full
        border-b-[2px] border-gray-400 placeholder-gray-400'/>
        <h2 className='text-[10px] mb-8 w-full  text-gray-400'>Os primeiros 40 caracteres são os que geralmente aparecem nos feeds</h2>
        <UserTag user={session?.user} />
        <textarea type="text"
          onChange={(e)=>setDesc(e.target.value)}
            placeholder='Diga a todos sobre o que é seu pin' 
